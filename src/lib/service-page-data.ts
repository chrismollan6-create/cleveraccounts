...
export const servicePages: Record<string, ServicePageData> = {
  ...
  "it-contractor-accountant": {
    ...
    title: "IT Contractor Accountants",
    headline: "Accountants for IT Contractors",
    description:
      "Specialist accounting for IT contractors working through a limited company — IR35 guidance, contract reviews, salary and dividend planning, VAT and year-end accounts, all handled by a named accountant for one fixed monthly fee.",
    metaDescription:
      "Accountants for UK IT contractors. IR35 support, contract reviews, salary & dividend planning, VAT, year-end accounts and director self assessment. Dedicated accountant, free FreeAgent, unlimited advice.",
    price: "104.50",
    features: [
      "Dedicated contractor accountant",
      "IR35 support & written contract reviews",
    ...
    benefits: [
      { title: "IR35 in plain English", description: "We assess your contracts and working practices and give you a clear written opinion — so you know where you stand before you sign." },
      { title: "Keep more of your day rate", description: "Proactive salary, dividend and pension planning structured around your contract so you're never overpaying HMRC." },
      { title: "A named accountant", description: "Not a call centre — one expert who understands contracting and is always a call away." },
      { title: "Everything handled", description: "Accounts, VAT, payroll, Companies House and your self assessment — all included for one fixed monthly fee." },
    ],
    faqs: [
      { q: "Do I need an accountant as an IT contractor?", a: "Practically, yes. As a limited company director you're responsible for Companies House filings, corporation tax, VAT, payroll and your own self assessment. A specialist contractor accountant typically pays for itself within the first year through tax planning alone." },
      { q: "Can you review my contracts for IR35?", a: "Yes — written contract review is included. We check your contract for IR35 indicators, advise on working practices, and give you a clear written opinion you can rely on." },
      { q: "What's the difference between inside and outside IR35?", a: "Outside IR35, your company receives the full rate and you take a tax-efficient mix of salary and dividends. Inside IR35, your day rate is taxed broadly like employment income. The difference is typically 15–25% of gross income, so getting your status right matters." },
      { q: "Is FreeAgent included?", a: "Yes — FreeAgent is included free, set up for you so you can see your numbers in real time and invoice on the go." },
      { q: "How quickly can I get set up?", a: "Most contractors are fully onboarded within a couple of business days, and we handle the switch from your current accountant for you." },
    ],
    testimonial: {
      name: "IT contractor",
      role: "Limited Company",
      quote: "Clear, straight answers on IR35 and my contracts whenever I need them, and everything filed on time. Exactly what a contractor needs.",
    },
  },
  "switching-accountants": {
    slug: "switching-accountants",
    title: "Switching Accountants",
    headline: "Switching Accountants Made Simple",
    description:
      "Thinking of moving accountants? We handle the whole switch for you — free of charge and with no gaps. We write to your current accountant, collect your records, and have you up and running in days.",
    metaDescription:
      "Switch accountants the easy way. We handle the entire move for free — professional clearance, record transfer and HMRC authorisation — with no disruption. Dedicated accountant, free software, unlimited advice.",
    price: "42.50",
    features: [
      "We handle the entire switch — free",
      "Professional clearance letter sent for you",
      "All your records collected from your old accountant",
      "HMRC agent authorisation set up",
      "Switch any time of year — not just year-end",
      "Free FreeAgent accounting software",
      "Dedicated named accountant",
      "Unlimited phone & email advice",
    ],
    benefits: [
      { title: "We do the heavy lifting", description: "You just sign up — we write to your current accountant and obtain all your records. No awkward conversations." },
      { title: "No gaps, no missed deadlines", description: "We make sure nothing slips through the cracks during the move, so your filings stay on time." },
      { title: "Switch whenever suits you", description: "You don't have to wait for your year-end — we can move you over at any point in the year." },
      { title: "A fresh start with a real accountant", description: "A named expert who actually replies, unlimited advice, and free software — all for one fixed monthly fee." },
    ],
    faqs: [
      { q: "Is switching accountants difficult?", a: "No — we handle the whole process for you, free of charge. You sign up, we write to your current accountant, obtain your records and set up HMRC authorisation. It's usually seamless." },
      { q: "Will there be a gap in my accounts?", a: "No. We coordinate the handover so your filings and deadlines are covered throughout the move — nothing is missed." },
      { q: "Do I have to tell my old accountant?", a: "A quick note to let them know you're leaving is all that's needed — we then send a formal professional clearance letter and request your records on your behalf." },
      { q: "Can I switch part-way through the year?", a: "Yes. You can move accountants at any point in the year; you don't need to wait for your year-end or company anniversary." },
      { q: "Is there a fee to switch?", a: "No — switching is completely free. You simply start your fixed monthly fee with us once you're set up." },
    ],
    testimonial: {
      name: "Limited company director",
      role: "Switched accountant",
      quote: "I expected switching to be a hassle — it wasn't. They sorted everything with my old accountant and I barely had to lift a finger.",
    },
  },
  "cis-accounting": {
    slug: "cis-accounting",
