 ...
 * and demos.
 *
 * Decision (2026-06-25): Documents + Notifications are deferred for the pilot
 * (Documents has no SF source model yet; Notifications are event-generated and
 * not yet wired). CH details, Approvals (MTD) and Deadlines DO get real sync,
