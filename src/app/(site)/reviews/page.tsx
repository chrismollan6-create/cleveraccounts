...
const allReviews = [
  ...TESTIMONIALS,
  {
    ...
    quote: "As a freelancer, I needed someone who understood my unique situation. My accountant has been brilliant — they handle everything and the software is so easy to use. I can do my invoicing on the go!",
    rating: 5,
  },
  {
    name: "Mark Henderson",
    role: "Property Landlord",
    quote: "Managing multiple rental properties used to be a headache at tax time. My accountant took all that stress away. They know property accounting inside and out.",
    rating: 5,
  },
  {
    name: "Rachel Adams",
  ...
  },
  {
    name: "Tom Nicholson",
    role: "IT Contractor",
    quote: "The umbrella solution is a game-changer for contractors. Being able to switch between PSC and umbrella seamlessly has saved me so much hassle with IR35 changes.",
    rating: 5,
  },
  {
    name: "Angela Brooks",
    role: "Sole Trader",
    quote: "I was terrified of Making Tax Digital but my accountant made the transition completely painless. They set everything up and walked me through it step by step.",
    rating: 5,
  },
  {
    name: "Chris Palmer",
    role: "Startup Founder",
    quote: "Starting a business is stressful enough without worrying about accounts. From day one, my accountant has been proactive, helpful and genuinely interested in my success.",
    rating: 5,
  },
  {
    name: "Priya Sharma",
  ...
  },
  {
    ...
    role: "Limited Company Director",
    quote: "Switched last year and haven't looked back. My previous accountant charged more for less. Here I get unlimited support and fantastic software included.",
    rating: 5,
  },
];
      ...
      <section className="relative overflow-hidden bg-dark py-20 md:py-28">
        ...
        <div className="relative max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-lg text-white/70 max-w-xl mx-auto mb-10">
            Thousands of sole traders, contractors, and limited companies trust {brand.name}. Here's what they say.
          </p>
            ...
            {brand.trustpilot && (
              <div>
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-white font-black text-xl">{brand.trustpilot.rating}</span>
                </div>
                <div className="text-white/60 text-xs">
                  {brand.trustpilot.reviewCount
                    ? `${brand.trustpilot.reviewCount} reviews on Trustpilot`
                    : "rated on Trustpilot"}
                </div>
              </div>
            )}
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-secondary via-secondary/90 to-orange-600 py-16 md:py-20">
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-black text-white mb-4">
            {brand.id === "clever" ? "Join 10,000+ Happy Businesses" : "Join Our Happy Businesses"}
          </h2>
          <p className="text-white/85 text-lg mb-8 max-w-xl mx-auto">
            Experience the {brand.name} difference. Dedicated accountant, free software, all-inclusive price.
          </p>
