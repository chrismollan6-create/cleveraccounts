...
export async function generateMetadata(): Promise<Metadata> {
  ...
  if (brand.id === "workwell") {
    return {
      title: `Privacy, Data & Cookie Policy`,
    ...
    <>
      <section className="relative overflow-hidden bg-dark py-16 md:py-20">
        ...
        <div className="relative max-w-4xl mx-auto px-4">
          ...
          <p className="text-white/60">Effective as of 16 November 2022</p>
        </div>
      ...
      <section className="bg-white py-16">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="mt-12 pt-8 border-t border-border">
            <h2 className="text-xl font-black text-dark mb-3">Contact Us</h2>
