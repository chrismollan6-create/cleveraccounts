...
function gradientLastWord(text: string) {
  ...
  const grad =
    "bg-gradient-to-r from-[#8db74e] via-[#8db74e] to-[#29484f] bg-clip-text text-transparent";
    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-[#eef4e2] via-[#f1f6e6] to-[#e4eed3]">
      ...
      <div className="relative max-w-7xl mx-auto px-4 pt-14 md:pt-20 pb-28 md:pb-32">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          {/* ── Left: message ─────────────────────────────────────────── */}
          <div>
            <div className="inline-flex items-center gap-2 bg-white/85 backdrop-blur border border-white shadow-sm rounded-full pl-2 pr-4 py-1.5 text-sm text-[#29484f] font-semibold mb-7">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-[4.4rem] font-extrabold text-[#29484f] leading-[1.05] tracking-tight mb-6">
              {home?.heroHeadline ? (
          ...
          <div className="relative lg:pl-4 max-w-md mx-auto lg:max-w-none">
            ...
            <div className="absolute -inset-3 rounded-[3rem] bg-gradient-to-tr from-[#8db74e]/10 via-[#8db74e]/15 to-[#8db74e]/10 blur-2xl hidden sm:block" />

            {/* Relatable photo — dropped down to leave headroom for top chips */}
            <div className="relative mt-12 sm:mt-10">
              <div className="absolute inset-0 translate-x-4 -translate-y-3 rotate-3 rounded-[2rem] bg-gradient-to-br from-[#8db74e]/40 to-[#8db74e]/40 hidden sm:block" />

              <div className="relative aspect-[4/3] rounded-[2rem] overflow-hidden shadow-2xl shadow-[#29484f]/25 border-4 border-white">
                <Image
                ...
                <div className="absolute inset-x-0 bottom-0 h-1/3 bg-gradient-to-t from-[#29484f]/30 to-transparent" />
              </div>
              ...
              <div className="absolute -top-5 left-1 sm:-left-5 bg-white rounded-2xl px-4 py-2.5 shadow-xl border border-[#e4ecd6] -rotate-3 animate-float z-30">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-sm font-bold text-[#29484f] ml-1">{rating}</span>
                </div>
            ...
            <div className="relative -mt-14 sm:-mt-16 ml-2 sm:ml-10 mr-2 sm:mr-0 bg-white rounded-[1.5rem] shadow-2xl shadow-[#29484f]/20 border border-white overflow-hidden z-20">
              {/* Gradient header strip */}
              <div className="bg-gradient-to-r from-[#29484f] via-[#4a6a72] to-[#8db74e] px-6 py-4 flex items-center gap-2 text-white">
                <Sparkles size={16} />
                <span className="text-xs font-bold uppercase tracking-wider">Everything included</span>
              </div>

              <div className="p-6">
                <p className="text-xl font-extrabold text-[#29484f] mb-4">
                    ...
                    <li key={item} className="flex items-center gap-2.5">
                      <span
                        className={`w-5 h-5 rounded-full flex items-center justify-center shrink-0 ${
                          i % 2 === 0 ? "bg-[#8db74e]/20 text-[#5f8a3e]" : "bg-[#8db74e]/25 text-[#2f5560]"
                        }`}
                      >
                        <CheckCircle2 size={13} />
                      </span>
                      <span className="text-[#29484f] font-medium text-sm">{item}</span>
                    </li>
                  ))}
                </ul>
                ...
                <div className="flex items-end justify-between pt-4 border-t border-[#eef2e4]">
                  <div>
                    ...
                    <p className="text-2xl font-extrabold text-[#29484f]">
                      £42.50<span className="text-sm font-semibold text-[#6a7b80]">/mo + VAT</span>
                    </p>
                  </div>
                  <Link
                    href="/pricing"
                    className="inline-flex items-center gap-1.5 bg-[#8db74e]/15 text-[#5f8a3e] font-bold text-sm px-4 py-2.5 rounded-xl hover:bg-[#8db74e]/25 transition-colors"
                  >
