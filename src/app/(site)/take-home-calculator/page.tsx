...
function calculatorJsonLd(brand: { name: string; domain: string }) {
  return {
    ...
    url: `https://${brand.domain}/take-home-calculator`,
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(calculatorJsonLd(brand)) }}
      />
      {/* ── HERO ─────────────────────────────────────────────── */}
