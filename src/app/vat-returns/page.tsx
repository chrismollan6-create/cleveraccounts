...
export const metadata: Metadata = {
  title: "VAT Return Service",
  description: "Online VAT return service for UK businesses. We prepare and submit your quarterly VAT returns on time, every time. Included in our Limited Company package.",
};
    ...
    <>
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-16 md:py-24">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold text-white leading-tight mb-6">
              VAT Return<br /><span className="text-primary-light">Service</span>
            </h1>
            <p className="text-lg text-white/85 leading-relaxed mb-8">
              We prepare and submit your quarterly VAT returns on time, every time. MTD compliant, hassle-free, and included in your monthly fee.
            </p>
      ...
      <section className="bg-white py-16 md:py-24">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {["Quarterly VAT return preparation", "MTD-compliant submission to HMRC", "VAT scheme advice (Flat Rate, Cash, Standard)", "Deadline monitoring & reminders", "VAT registration assistance", "Voluntary registration guidance", "Input VAT recovery", "Unlimited VAT advice"].map((f) => (
      ...
      <section className="gradient-hero py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">VAT Returns Sorted</h2>
