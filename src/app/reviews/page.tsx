          ...
          <div className="inline-flex flex-col sm:flex-row items-center gap-6 bg-white/[0.08] border border-white/15 backdrop-blur-sm rounded-2xl px-8 py-5">
              ...
              <div>
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <div className="flex gap-0.5">
                    {[...Array(5)].map((_, i) => (
                      <Star key={i} size={14} className="fill-current" style={{ color: "#00B67A" }} />
                    ))}
                  </div>
                </div>
                <div className="text-white/60 text-xs">4.7 · 746 reviews</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              <div>
                ...
                <div className="text-white/60 text-xs">4.4 · 479 reviews</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-surface py-10 border-b border-border">
        <div className="max-w-4xl mx-auto px-4">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 text-center">
            {[
              { icon: Star, value: "4.7 / 5", label: "Trustpilot rating", colour: "text-[#00B67A]" },
