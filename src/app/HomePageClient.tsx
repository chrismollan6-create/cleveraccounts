            ...
            <div className="hidden lg:block relative">
                  ...
                  {[
                    ...
                    <div key={i} className="flex items-center gap-4 bg-white/5 rounded-2xl p-4 border border-white/5 hover:bg-white/10 transition-all">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-primary-light text-sm">{person.role}</p>
              ...
              <div className="absolute -top-2 -right-4 bg-white rounded-2xl p-3 shadow-xl animate-float z-10">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-bold text-dark ml-1">4.7</span>
                </div>
                <p className="text-xs text-text-light mt-1">on Trustpilot · 746 reviews</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="relative py-24 md:py-32 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="text-center mb-14">
            <span className="text-primary-light font-bold text-sm uppercase tracking-wider">Tailored For You</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            <div>
              ...
              <div className="inline-flex items-center gap-2 bg-primary/20 rounded-full px-4 py-2 text-primary-light text-sm font-bold mb-8 border border-primary/30">
                <BarChart3 size={16} />
                {activeService.stat}
              </div>
      ...
      <section className="relative py-20 md:py-28 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4">
          <div className="text-center mb-12">
            <span className="text-primary-light font-bold text-sm uppercase tracking-wider">Answers</span>
            <h2 className="text-4xl md:text-5xl font-black text-white mt-3">
          ...
          <div className="text-center mt-10">
            <p className="text-white/60">
              ...
              <Link href="/faq" className="text-primary-light font-semibold hover:text-white transition-colors">
