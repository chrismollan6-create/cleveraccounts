...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      name: "sections",
      title: "Section headings (optional)",
      description: "Override the on-page section headings/intros. Leave any blank to use the built-in default.",
      type: "object",
      options: { collapsible: true, collapsed: true },
      fields: [
        { name: "featuresEyebrow", title: "What's included — eyebrow", type: "string" },
        { name: "featuresHeading", title: "What's included — heading", type: "string" },
        { name: "benefitsEyebrow", title: "Benefits — eyebrow", type: "string" },
        { name: "benefitsHeading", title: "Benefits — heading", type: "string" },
        { name: "categoriesEyebrow", title: "What we do — eyebrow", type: "string" },
        ...
        { name: "ctaHeading", title: "Closing CTA — heading", type: "string" },
        { name: "ctaBody", title: "Closing CTA — text", type: "text", rows: 2 },
      ],
    }),
    defineField({
      name: "pageSchemas",
