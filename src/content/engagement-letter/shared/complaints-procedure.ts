...
export const COMPLAINTS_PROCEDURE: Section[] = [
  {
    ...
    body:
      ...
      'The following is the standard complaints procedure for Clever Accounts Ltd. If you are unhappy with any aspect of the service you receive from Clever Accounts Ltd you should do the following:\n\n' +
      ...
      '    Email: {{supportEmail}}\n\n' +
      '    Post: Brookfield Court, Selby Road, Leeds, LS25 1NB\n\n' +
